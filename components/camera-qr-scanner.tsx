                  ...
                  <div className="relative">
                    ...
                    {scanResult ? (
                      <div className="text-center">
                        ...
                        <p className="text-green-200 text-sm">Processing patient data...</p>
                      </div>
                    ) : (
                      <div>
                        {/* Corner markers */}
                        <div className="w-64 h-64 relative">
                          {/* Top-left corner */}
                          <div className={`absolute top-0 left-0 w-8 h-8 border-t-4 border-l-4 ${isScanning ? 'border-green-200' : 'border-gray-400'}`}></div>
                          {/* Top-right corner */}
                          <div className={`absolute top-0 right-0 w-8 h-8 border-t-4 border-r-4 ${isScanning ? 'border-green-200' : 'border-gray-400'}`}></div>
                          {/* Bottom-left corner */}
                          <div className={`absolute bottom-0 left-0 w-8 h-8 border-b-4 border-l-4 ${isScanning ? 'border-green-200' : 'border-gray-400'}`}></div>
                          {/* Bottom-right corner */}
                          <div className={`absolute bottom-0 right-0 w-8 h-8 border-b-4 border-r-4 ${isScanning ? 'border-green-200' : 'border-gray-400'}`}></div>
                          
                          {/* Scanning line animation */}
                          {isScanning && (
                            <div className="absolute inset-0 flex items-center justify-center">
                              <div className="w-full h-1 bg-green-200 opacity-75 animate-pulse"></div>
                            </div>
                          )}
                        </div>
